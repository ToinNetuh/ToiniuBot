...
const { toinmenu } = require('./database/menu/toinmenu')
const { menuadmin } = require('./database/menu/menuadmin')
...
const vcard = 'BEGIN:VCARD\n' // metadata of the contact card
            ...
            + 'TEL;type=CELL;type=VOICE;waid=5562996638900:+55 (62) 99663-8900\n' // ID do WhatsApp + número de telefone
            + 'END:VCARD'
/******END OF VCARD INPUT******/
...
async function starts() {
	...
	client.on('chat-update', async (mek) => {
		try {
			...
			const ownerNumber = ["5562996638900@s.whatsapp.net"] // replace this with your number
			...
			const isOwner = ownerNumber.includes(sender)
                        ...
                        const NomerOwner = '5562996638900@s.whatsapp.net'
                        /******ApiKey Input******/
